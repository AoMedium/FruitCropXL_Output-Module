 ...
 */
@Deprecated
public class CsvSteppingWriter {
     ...
     */
    public CsvSteppingWriter(String filePath, Class pojoType) {
     ...
     * @param pojoType The class of the POJO type to write out.
     */
    public CsvSteppingWriter(String id, String filePath, Class pojoType) {
        this.id = id;
    ...
    public static void write(Object object, String filePath, CsvMapper mapper) {
        ...
        try (FileWriter fileWriter = new FileWriter(filePath, true)) {
            if (!fileExist) { // Write header if writing to a new file
                fileWriter.write(CsvSteppingWriter.getHeader(mapper, schema)); // Write header
            }

            fileWriter.append(CsvSteppingWriter.getHeaderlessCsv(object, mapper, schema));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
